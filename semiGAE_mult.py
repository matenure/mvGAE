...
flags.DEFINE_string('model', 'semiencoder', 'Model string.')  # 'gcn', 'semiencoder', 'attSemiGAE'
...
for epoch in range(FLAGS.epochs):
    ...
    # Training step
    outs = sess.run([model.opt_op, model.loss, model.accuracy, model.activations,model.predict(),model.mix], feed_dict=feed_dict)
