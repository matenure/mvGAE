...
from attentionModel import AttSemiGraphEncoder
...
for epoch in range(FLAGS.epochs):
    ...
    # Training step
    outs = sess.run([model.opt_op, model.loss, model.accuracy, model.activations,model.predict()], feed_dict=feed_dict)
